...
object BasicPolynomialTesting extends App {
  ...
  val a: Poly[Rational] = new Poly(Array(Term(r"1/100", 1), Term(r"2/1", 3), Term(r"-17/19", 2)))
  val b: Poly[Rational] = new Poly(Array(Term(r"1/2", 1), Term(r"-3/2", 3), Term(r"1/4", 2)))
